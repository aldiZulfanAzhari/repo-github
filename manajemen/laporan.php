        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-print"></i> &nbsp PRINT</a>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td colspan="2" class="text-center text-bold text-white bg-success"><?php echo "Rp. " . number_format($total_pemasukan - $total_pengeluaran) . " ,-"; ?></td>
                    </tr>
                  </tbody>
                </table>
