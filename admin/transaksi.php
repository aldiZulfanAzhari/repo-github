                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <p class="help-block">File <?php echo "<a class='fancybox btn btn-xs btn-success' target=_blank href='../gambar/bukti/$d[transaksi_foto]'>$d[transaksi_foto]</a>"; ?> tidak dirubah kosongkan saja</p>
                                  </div>
